// LanTran.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CLanTranApp, CWinApp)
	//{{AFX_MSG_MAP(CLanTranApp)
...
/////////////////////////////////////////////////////////////////////////////
// CLanTranApp construction

CLanTranApp::CLanTranApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CLanTranApp object

CLanTranApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CLanTranApp initialization
int CDrawButton::m_Style = 1;
HHOOK  hWndHook ;
BOOL CLanTranApp::InitInstance()
{
	if (!AfxSocketInit())
	{
